...
public class ContactAnimalServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Animal newAnimal = createAnimalObject(animalId);
        ...
        contactAnimalService.addContactAnimal(newAnimal,name, surname, email, message);
    ...
    private Animal createAnimalObject(Long animalId) {
        Animal animal = null;
        AnimalService animalService = new AnimalService();
        animal = animalService.getAnimalById(animalId);
        return animal;
